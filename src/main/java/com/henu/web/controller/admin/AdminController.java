...
import com.henu.base.HouseOperation;
...
//        }
    ...
    public String housePageEdit(@RequestParam(value = "id") Long id, Model model) {
        if (id == null || id < 0) {
            return "404";
        }
        ServiceResult<HouseDTO> serviceResult = houseService.findCompletaOne(id);
    ...
    public ApiResponse saveHouse(@Valid @ModelAttribute("form-house-edit") HouseForm houseForm,
        ...
        response.setMes(result.getMessage());
        return response;
    }
